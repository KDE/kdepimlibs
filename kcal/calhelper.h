...
namespace CalHelper {
  ...
  /**
    ...
    @since 4.4
  */
  KCAL_EXPORT_DEPRECATED_DEPRECATED bool isMyKolabIncidence( Calendar *calendar, Incidence *incidence );
  ...
  /**
    ...
    @since 4.4
  */
  KCAL_EXPORT_DEPRECATED_DEPRECATED bool isMyCalendarIncidence( Calendar *calendar, Incidence *incidence );
  ...
  /**
    ...
    @since 4.4
  */
  KCAL_EXPORT_DEPRECATED_DEPRECATED Incidence *findMyCalendarIncidenceByUid( Calendar *calendar, const QString &uid );
