...
KCAL_EXPORT icalcomponent* icalcomponent_new(icalcomponent_kind kind);
KCAL_EXPORT icalcomponent* icalcomponent_new_clone(icalcomponent* component);
KCAL_EXPORT icalcomponent* icalcomponent_new_from_string(char* str);
KCAL_EXPORT icalcomponent* icalcomponent_vanew(icalcomponent_kind kind, ...);
KCAL_EXPORT void icalcomponent_free(icalcomponent* component);

char* icalcomponent_as_ical_string(icalcomponent* component);

int icalcomponent_is_valid(icalcomponent* component);

KCAL_EXPORT icalcomponent_kind icalcomponent_isa(const icalcomponent* component);
...
KCAL_EXPORT icalcomponent* icalcomponent_get_first_component(icalcomponent* component,
					      icalcomponent_kind kind);
KCAL_EXPORT icalcomponent* icalcomponent_get_next_component(icalcomponent* component,
					      icalcomponent_kind kind);
