...
#    define KCALCORE_DEPRECATED_EXPORT KDE_DEPRECATED KCALCORE_EXPORT
#    define KCALCORE_DEPRECATED KDE_DEPRECATED
#  else
#    define KCALCORE_EXPORT_DEPRECATED KCALCORE_EXPORT
#    define KCALCORE_DEPRECATED_EXPORT KCALCORE_EXPORT
#  endif
# endif
