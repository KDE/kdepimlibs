...
#   define KRESOURCES_DEPRECATED_EXPORT KDE_DEPRECATED KRESOURCES_EXPORT
#   define KRESOURCES_DEPRECATED KDE_DEPRECATED
# else
#   define KRESOURCES_EXPORT_DEPRECATED KRESOURCES_EXPORT
#   define KRESOURCES_DEPRECATED_EXPORT KRESOURCES_EXPORT
# endif
#endif
