...
void KLineEdit::updateClearButtonIcon(const QString& text)
{
    ...
    if (layoutDirection() == Qt::LeftToRight) {
        d->clearButton->setPixmap(SmallIcon("edit-clear-locationbar-rtl", minIconSize, clearButtonState));
    } else {
        d->clearButton->setPixmap(SmallIcon("edit-clear-locationbar-ltr", minIconSize, clearButtonState));
    }
