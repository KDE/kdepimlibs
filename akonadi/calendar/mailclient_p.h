...
public:
    ...
    explicit MailClient(QObject *parent = 0, MessageQueueJobFactory *factory=new MessageQueueJobFactory());
    ~MailClient();
    ...
    void mailAttendees(const KCalCore::IncidenceBase::Ptr &incidence,
                       ...
                       MessageQueueJobFactory *factory = 0);
    ...
    /**
      ...
      @param factory defines the job that is used to send the mail
      @since 4.15
    */
    void send(const KCalCore::IncidenceBase::Ptr &incidence, const KPIMIdentities::Identity &identity, const QString &from, const QString &to,
              ...
              const QString &mailTransport = QString(), MessageQueueJobFactory *factory = 0);
