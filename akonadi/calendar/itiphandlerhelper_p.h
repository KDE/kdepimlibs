...
class ITIPHandlerHelper : public QObject
{
    Q_OBJECT
public:
    explicit ITIPHandlerHelper(QWidget *parent = 0, MessageQueueJobFactory *factory = new MessageQueueJobFactory());   // TODO
    ~ITIPHandlerHelper();
    ...
    enum SendResult {
        ...
        ResultPending          /**< The user has be ask about one detail, waiting for him to anwser it */
    };
...
private:
    ...
    */
    ...
    Status m_status;
    MessageQueueJobFactory *m_factory;
};
