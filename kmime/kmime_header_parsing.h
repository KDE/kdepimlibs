...
bool parseAtom( const char* &scursor, const char * const send,
                ...
                bool allow8Bit=false )KMIME_EXPORT;
...
bool parseGenericQuotedString( const char* &scursor, const char* const send,
                               ...
                               const char openChar='"',
                               const char closeChar='"' ) KMIME_EXPORT;
...
bool parseComment( const char* &scursor, const char * const send,
                   ...
                   bool reallySave=true ) KMIME_EXPORT;
 ...
 */
void eatCFWS( const char* &scursor, const char * const send,
              bool isCRLF ) KMIME_EXPORT;
...
bool parseTime( const char* &scursor, const char * const send, int &hour,
