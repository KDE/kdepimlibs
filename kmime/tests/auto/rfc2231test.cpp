...
void RFC2231Test::testRFC2231decode()
{
 ...
 /// empty
  ...
  // identity
  QCOMPARE( KMime::decodeRFC2231String( "bla", encCharset, "utf-8", false ), QString( "bla" ) );
  // utf-8
...
/*  QCOMPARE( KMime::decodeRFC2231String( "=?utf-8?q?Ingo=20Kl=C3=B6cker?= <kloecker@kde.org>", encCharset, "iso8859-1", false ),
            QString::fromUtf8( "Ingo KlÃ¶cker <kloecker@kde.org>" ) );
  QCOMPARE( KMime::decodeRFC2231String( "=?utf-8?q?Ingo=20Kl=C3=B6cker?=", encCharset, "utf-8", false ),
  ...
  QCOMPARE( decodeRFC2047String( "Subject: =?utf-8?Q?Ð¿ÐžÑ¿ÐžÐ»Ð»,=20=D0=B4=D0=BE=D0=B1=D1=80=D1=8B=D0=B9=20=D0=B4=D0=B5=D0=BD=D1=8C?=", encCharset ),
            QString::fromUtf8( "Subject: Ð¿ÐžÑ¿ÐžÐ»Ð», ÐŽÐŸÐ±ÑÑÐ¹ ÐŽÐµÐœÑ" ) );
  QCOMPARE( decodeRFC2047String( "Subject: =?iso-8859-1?Q?ÖÄÜöäü?=" ),
