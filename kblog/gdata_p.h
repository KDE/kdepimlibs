...
class GDataPrivate : public BlogPrivate
{
  public:
    ...
    virtual void slotListRecentPosts(Syndication::Loader*, Syndication::FeedPtr, Syndication::ErrorCode);
    virtual void slotFetchPost(Syndication::Loader*, Syndication::FeedPtr, Syndication::ErrorCode);
